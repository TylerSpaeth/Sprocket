...
namespace Sprocket {
    ...
    void TransformComponent::OnActivate(OnActivateParams& onActivateParams) {}
    void TransformComponent::OnDeactivate(OnDeactivateParams& onDeactivateParams) {}
    void TransformComponent::OnUpdate(OnUpdateParams& onUpdateParams) {}
